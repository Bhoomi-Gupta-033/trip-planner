...
//           <div className="w-24 h-24 rounded-full bg-white dark:bg-gray-900 border-4 border-[var(--bg)] flex items-center justify-center text-3xl font-bold text-emerald-500 translate-y-12 shadow-xl">
...
//                   >
//                     <div className="w-20 h-16 rounded-lg overflow-hidden bg-gray-200 dark:bg-gray-800 flex-shrink-0">
//                       {images[trip._id] ? (
//                         <img
//                           src={images[trip._id]}
//                           alt={trip.destination}
