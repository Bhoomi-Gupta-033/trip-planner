...
//       <div
//         className="
//         max-w-5xl mx-auto p-6 rounded-2xl shadow-xl
...
//           {/* Stats */}
//           <div className="flex justify-center md:justify-start gap-6 mt-4 bg-[var(--bg)] text-[var(--text)] ">
//             <div>
...
//           <button
//             onClick={logout}
//             className="px-5 py-2 bg-red-500 rounded-lg text-white hover:bg-red-600"
//           >
//             Logout
//           </button>
//         </div>
...
//       {/* MY TRIPS */}
//       <div className="max-w-5xl mx-auto mt-10 bg-[var(--bg)] text-[var(--text)] ">
//         <h2 className="text-xl font-semibold mb-4">Your Trips 🧳</h2>

//         {trips.length === 0 ? (
//           <p className="text-gray-400">No trips yet</p>
//         ) : (
//           <div className="grid md:grid-cols-2 gap-5 bg-[var(--bg)] text-[var(--text)] ">
//             {trips.map((trip) => (
//               <div
//                 key={trip._id}
//                 className="
...
//                 <a
//                   href={`/trip/${trip._id}`}
//                   className="inline-block mt-3 text-blue-500 dark:text-green-400 hover:underline"
//                 >
//                   View Details →
//                 </a>
//               </div>
...
//       {/* 🔥 SAVED TRIPS MODAL */}
//       {showSaved && (
//         <div className="fixed inset-0  flex justify-center items-center z-50 bg-[var(--bg)] text-[var(--text)] ">
//           <div
//             className="
//             bg-[var(--bg)] text-[var(--text)]
//             w-full max-w-2xl p-6 rounded-xl shadow-xl
